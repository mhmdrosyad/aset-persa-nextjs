        ...
        <>
            <div className="hidden lg:flex">
                    <div className="bg-white fixed h-full z-20 py-6 px-16 shadow-sm flex flex-col">
                        <div className="flex items-center gap-6 mb-12">
                            <Link href="/aset/admin" className="me-1 flex items-center">
                        ...
                        <div className="flex flex-col gap-8 text-gray-500">
                            ...
                            <Link className="font-semibold flex gap-4" href='/aset/admin/peminjam'><FontAwesomeIcon className="w-6 h-6" icon={faUsers} />Daftar Peminjam</Link>
                        </div>
            ...
            <div className="lg:hidden z-10 fixed bottom-0 w-full py-5 px-2 bg-white rounded-t-lg">
                <div className="flex gap-16 items-center justify-center text-xl">
                    ...
                    <Link href='/aset/admin/add'><FontAwesomeIcon size='lg' icon={faPlusSquare} /></Link>
                    <Link href='/aset/admin'><FontAwesomeIcon size='lg' icon={faFileSignature} /></Link>
                </div>
            </div>
        </>
    )
